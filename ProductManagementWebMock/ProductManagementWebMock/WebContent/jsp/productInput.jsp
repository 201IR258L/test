...
<div class="container">
	...
	<div class="card mt-3">
		...
		<div class="card-body">
			...
			<form action="${pageContext.request.contextPath}/jsp/productInputComplete.jsp" method="post" class="col-8">
				<div class="form-group row">
					<label for="productId" class="col-md-2 col-form-label">商品ID</label>
					<div class="col-md-10">
						<input type="text" class="form-control" id="productId" value="0001">
					</div>
				</div>
				<div class="form-group row">
